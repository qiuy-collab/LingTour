...
export const mockEvents: Event[] = [
  {
    id: 'event_1',
    title: '潮汕功夫茶文化节',
    titleEn: 'Chaoshan Kungfu Tea Festival',
    date: '2026-06-15',
    endDate: '2026-06-18',
    city: '潮州',
    citySlug: 'chaozhou',
  ...
  },
  {
    id: 'event_2',
    title: '广府龙舟邀请赛',
    titleEn: 'Guangfu Dragon Boat Invitational',
    date: '2026-05-20',
    endDate: '2026-05-22',
    city: '广州',
    citySlug: 'guangzhou',
    adcode: 440100,
    tags: ['龙舟', '端午节', '体育'],
    summary: '粤港澳大湾区12支龙舟队齐聚珠江，三天激烈角逐展现岭南水乡魅力。',
    summaryEn: 'Twelve dragon boat teams from the Greater Bay Area gather on the Pearl River for three days of competition, showcasing Lingnan water town charm.',
    description: '一年一度的广府龙舟邀请赛将在珠江广州段举行。来自粤港澳大湾区的12支龙舟队伍将展开激烈角逐。\n\n活动亮点：\n• 传统龙舟点睛仪式\n• 500米直道竞速赛\n• 龙舟文化展览\n• 现场粽子和岭南美食市集\n• 亲子龙舟体验区\n\n龙舟赛不仅是一项体育竞技，更是广府地区传承千年的文化符号。',
    descriptionEn: 'The annual Guangfu Dragon Boat Invitational will be held on the Pearl River\'s Guangzhou section. Twelve teams from the Greater Bay Area will compete fiercely.\n\nHighlights:\n• Traditional dragon boat eye-dotting ceremony\n• 500m straight-course racing\n• Dragon boat culture exhibition\n• On-site zongzi and Lingnan food market\n• Family dragon boat experience zone\n\nDragon boat racing is not just a sport — it is a cultural symbol passed down for millennia in the Guangfu region.',
  ...
  },
  {
    id: 'event_3',
    title: '湛江海鲜美食博览会',
    titleEn: 'Zhanjiang Seafood Gourmet Expo',
    date: '2026-04-05',
    endDate: '2026-04-08',
    city: '湛江',
    citySlug: 'zhanjiang',
...
export const mockHomeConfig: HomeConfig = {
  heroStats: [
    {
      ...
      titleEn: '12+',
      description: '深度探索城市',
      descriptionEn: 'Cities Explored',
    },
    {
      title: '40+',
      titleEn: '40+',
      description: '精心设计路线',
      descriptionEn: 'Curated Routes',
    },
    {
      title: '200+',
      titleEn: '200+',
      description: '本地文化达人',
      descriptionEn: 'Local Culture Guides',
    },
    {
      title: '5000+',
      titleEn: '5000+',
      description: '满意旅客',
      descriptionEn: 'Happy Travelers',
    },
  ],
  trustMetrics: [
    { value: '100%', label: '本地团队', labelEn: 'Local Team' },
    { value: '24/7', label: '旅行支持', labelEn: 'Travel Support' },
    { value: '4.9/5', label: '用户评分', labelEn: 'User Rating' },
  ],
  entryCards: [
    {
      title: '城市文化',
      titleEn: 'City Culture',
      description: '深入岭南城市肌理，读懂每一座城',
      descriptionEn: 'Dive into Lingnan urban fabric, understand each city',
      image: 'https://picsum.photos/400/300?random=301',
      link: '/culture',
    },
    {
      title: '故事路线',
      titleEn: 'Story Routes',
      description: '围绕单一主题的沉浸式旅行体验',
      descriptionEn: 'Immersive single-theme travel experiences',
      image: 'https://picsum.photos/400/300?random=302',
      link: '/routes',
    },
    {
      title: '口译陪同',
      titleEn: 'Interpreting',
      description: '英语本地陪同，沟通零障碍',
      descriptionEn: 'English local companion, zero barrier communication',
    ...
    },
    {
      title: '文创商城',
      titleEn: 'Shop',
      description: '把岭南文化带回家',
      descriptionEn: 'Bring Lingnan culture home',
  ...
  cultureHighlights: [
    {
      title: '潮汕功夫茶',
      titleEn: 'Chaoshan Kungfu Tea',
      description: '二十一式冲泡，一杯茶里的千年功夫',
      descriptionEn: '21-step brewing ritual — a thousand years of mastery in one cup',
      image: 'https://picsum.photos/600/400?random=401',
      citySlug: 'chaozhou',
    },
    {
      title: '广府骑楼',
      titleEn: 'Guangfu Qilou',
      description: '岭南建筑独特的骑楼文化长廊',
      descriptionEn: 'The unique arcaded architecture corridor of Lingnan',
      image: 'https://picsum.photos/600/400?random=402',
      citySlug: 'guangzhou',
    },
    {
      title: '湛江海岸',
      titleEn: 'Zhanjiang Coast',
      description: '中国大陆最南端的火山海岸线',
      descriptionEn: 'The volcanic coastline at the southernmost tip of mainland China',
  ...
  testimonials: [
    {
      quote: '在凌云游的帮助下，我第一次真正走进了广东的文化深处，而不仅仅是观光。',
      quoteEn: 'With LingTour\'s help, I truly walked into the cultural depth of Guangdong for the first time, not just sightseeing.',
      author: '李女士',
      authorEn: 'Ms. Li',
      avatar: 'https://picsum.photos/80/80?random=501',
    },
    {
      quote: 'The Chaoshan tea culture route changed my understanding of what travel can be. Highly recommended!',
      quoteEn: 'The Chaoshan tea culture route changed my understanding of what travel can be. Highly recommended!',
      author: 'James K.',
      authorEn: 'James K.',
      avatar: 'https://picsum.photos/80/80?random=502',
    },
    {
      quote: '口译员不仅翻译语言，更像是一位文化向导，让我们的商务考察变得异常顺利。',
      quoteEn: 'The interpreter was not just a translator, but more like a cultural guide, making our business trip exceptionally smooth.',
      author: '王总',
      authorEn: 'Mr. Wang',
