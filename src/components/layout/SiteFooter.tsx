      ...
      <Container className="grid gap-10 py-12 lg:grid-cols-[1.3fr_0.8fr_1fr]">
        <div className="space-y-4">
          ...
          <p className="max-w-md text-sm leading-7 text-white/68">
            A cultural travel service platform for international visitors exploring Guangdong through
            city stories, interpretation support, and Lingnan-inspired products.
          </p>
        </div>

        <div>
          <p className="mb-4 text-label text-white/48">Explore</p>
        ...
        <div className="space-y-3 text-sm text-white/68">
          ...
          <p>2026 LingTour. All rights reserved.</p>
        </div>
      </Container>
    </footer>
  );
