    ...
    <div>
      ...
      <section className="site-container py-16 lg:py-24">
        <div className="grid gap-10 lg:grid-cols-[0.72fr_1.28fr]">
          ...
          <div className="grid gap-px overflow-hidden border border-[var(--line)] bg-[var(--line)] md:grid-cols-3">
            {values.map((value) => (
              <article key={value.title} className="bg-[var(--paper)] p-6">
        ...
        <div className="site-container grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link href="/routes" className="bg-[var(--river-deep)] px-6 py-4 text-center text-sm text-white">
                View routes
              </Link>
          ...
          <div className="grid gap-px overflow-hidden border border-[var(--line)] bg-[var(--line)]">
            {teamRoles.map((role, index) => (
              <div key={role} className="grid grid-cols-[4.5rem_1fr] bg-white">
      ...
      <section className="site-container py-16 lg:py-24">
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {milestones.map((item) => (
            <article key={item.label} className="border border-[var(--line)] bg-[var(--paper)] p-6">
      ...
      <section className="site-container pb-16">
        <div className="bg-[var(--night)] p-8 text-white lg:p-10">
          <div className="grid gap-8 lg:grid-cols-[1fr_auto] lg:items-end">
            ...
            <Link href="/interpreting#booking" className="bg-[var(--cinnabar)] px-6 py-4 text-center text-sm text-white">
              Start a request
            </Link>
          </div>
        </div>
