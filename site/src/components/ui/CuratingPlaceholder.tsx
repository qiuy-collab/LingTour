...
export function CuratingPlaceholder({ cityName }: Props) {
  ...
  return (
    <div className="flex min-h-[60svh] flex-col items-center justify-center px-6 py-16 text-center">
      <p className="text-[12px] font-bold uppercase tracking-[0.24em] text-[var(--cinnabar)]">
        {"Record Status"}
      </p>
      ...
      <span className="mt-6 border border-[var(--line)] bg-white/60 px-4 py-2 text-[12px] font-bold uppercase tracking-[0.18em] text-[var(--muted)]">
        {"Not Published"}
      </span>
