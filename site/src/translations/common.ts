export const common = {
  en: {
    ...
    "community.empty.body": "The board starts with the first note. If you found something worth sharing, it can be yours.",
    "community.empty.cta": "Write the first note",
    ...
    "community.error.dispatchFailed": "Could not post this note right now.",
