...
const values = [
  {
    ...
    body: "We design routes around a single cultural thread: city memory, food rhythm, craft, migration, or maritime life. The thread holds the day together.",
  },
  {
    title: "International first",
    body: "The platform is built for international visitors. Explanations avoid local shorthand. Cultural context is turned into clear, visitable stories.",
  },
  {
    title: "Service plus object",
...
const milestones = [
  {
    ...
    body: "Build route concepts from real city culture, field research, public information, and international visitor needs.",
  },
  {
    label: "02",
    title: "Turn routes into interface",
    body: "Use interactive maps, image-led cards, story-driven layouts, and booking flows to make culture easy to choose and follow.",
  },
  {
    label: "03",
    title: "Connect service and memory",
    body: "Add interpreting support and cultural products so the platform can move from inspiration to booking.",
  },
];
    ...
    <div>
      <section className="relative overflow-hidden bg-[var(--night)] py-20 text-white lg:py-28">
        ...
        <EditorialIntro
          ...
          title="Guangdong travel, told through stories visitors can follow."
          description="LingTour is a cultural travel platform for international visitors in Guangdong. It connects city culture, story-shaped routes, interpreter booking, and Lingnan-inspired products into one experience."
        />
      </section>
        ...
        <div className="site-container grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <Reveal>
            <div>
              ...
              <h2 className="mt-4 font-[family:var(--font-display)] text-4xl leading-tight text-[var(--river-deep)] md:text-5xl">
                Built by a student innovation team.
              </h2>
              <p className="mt-6 max-w-2xl text-base leading-8 text-[var(--muted)]">
                The project brings together web development, cultural research, route design, service
                planning, and international-facing communication — all toward a real, working platform
                for cultural travel in Guangdong.
              </p>
