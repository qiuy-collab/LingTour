...
const loginSteps = [
  ["01", "Enter email", "Use the demo account or your own email to create a travel profile."],
  ["02", "Save interests", "Choose the type of Guangdong trip you want to plan."],
  ["03", "Open account", "After submitting, LingTour takes you to your personal centre."],
];
      ...
      <section className="relative overflow-hidden bg-[var(--night)] text-white">
        ...
        <div className="site-container relative z-10 grid min-h-[calc(100svh-73px)] gap-8 py-8 lg:grid-cols-[0.82fr_0.58fr] lg:items-center lg:gap-10 lg:py-20">
          ...
          <div className="order-1 lg:order-2">
            <LoginPanel />
            <div className="mt-4 flex overflow-hidden border border-white/12 bg-white/12 text-sm">
              <Link href="/culture" className="w-full bg-white/8 px-5 py-4 text-center text-white/76 transition hover:bg-white hover:text-[var(--night)]">
                Continue browsing
              </Link>
            </div>
          </div>
