...
async function seed() {
  ...
  const zhanjiangRes = await dataSource.query(
    ...
    [
      ...
      j({
        en: 'At the southern edge of mainland China, Zhanjiang faces the South China Sea with a confidence that feels tidal rather than metropolitan.',
        zh: '在中国大陆最南端，湛江以一种更接近潮汐而非都市节拍的方式面向南海。',
      }),
      j(['Coast', 'Seafood', 'Volcanic landscape']),
      j({
        en: 'Zhanjiang is best entered as a field notebook rather than a checklist: a coastal city shaped by maritime labour, black basalt landforms, and a food culture that begins at sea.',
        zh: '湛江最适合被当成一本田野手记来阅读：这是一座被海上劳动、黑色玄武岩地貌和饮食文化共同塑造的海岸城市。',
      }),
      j([
        '/uploads/seed/zhanjiang-hero-1200.jpg',
        '/uploads/seed/southern-coast-1200.jpg',
      ]),
      j({ en: 'Flavours of Zhanjiang', zh: '湛江风味' }),
      j({
        en: "Zhanjiang's food is the most immediate way to understand how coastline, weather, labour, and geology are translated into daily life.",
        zh: '湛江的饮食是理解海岸线、天气、劳动方式和地质条件如何转译为日常生活的最直接入口。',
      }),
      j([
        '/uploads/seed/volcanic-landscape-800.jpg',
        '/uploads/seed/seafood-dishes-800.jpg',
      ]),
      j(['chaozhou']),
    ],
  );
  ...
  const chaozhouRes = await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Chaozhou is a city where ritual and daily life have never fully separated. Tea, porcelain, opera, and food exist not as heritage categories but as living rhythms.',
        zh: '潮州是一座仪式与日常从未完全分离的城市。茶、瓷器、戏曲和饮食不是遗产类别，而是活着的节奏。',
      }),
      j(['Tea culture', 'Porcelain', 'Heritage']),
      j({
        en: 'Chaozhou rewards slowness. Its culture is best understood through repetition — the same tea poured again, the same street walked twice, the same craft observed at different hours.',
        zh: '潮州奖赏慢下来的人。它的文化最适合通过重复来理解——同一壶茶再泡一次，同一条街再走一遍，同一门手艺在不同时段观察。',
      }),
      j([
        '/uploads/seed/chaozhou-hero-1200.jpg',
        '/uploads/seed/chaozhou-tea-1200.jpg',
      ]),
      j({ en: 'Chaozhou Cuisine', zh: '潮州菜' }),
      j({
        en: 'Chaozhou cuisine is precise, seasonal, and deeply tied to ritual. From morning congee to evening hotpot, every meal carries centuries of refinement.',
        zh: '潮州菜精确、应季，与仪式深度绑定。从早粥到晚间打边炉，每一餐都承载着数百年的精炼。',
      }),
      j([
        '/uploads/seed/chaozhou-food-800.jpg',
        '/uploads/seed/chaozhou-tea-800.jpg',
      ]),
      j(['zhanjiang']),
    ],
  );
  ...
  await dataSource.query(
    ...
    [
      ...
      j({ en: 'Southern coast', zh: '南方海岸' }),
      j({
        en: "Zhanjiang's coastline is long, open, and working. It shifts through harbours, mudflats, mangroves, and beaches that belong as much to fishers as to visitors.",
        zh: '湛江的海岸线漫长、开阔，而且仍然在工作。它在渔港、滩涂、红树林与公共海滩之间不断切换。',
      }),
      j({ en: 'Coastline', zh: '海岸线' }),
      j({ en: '1,243 km', zh: '1243 公里' }),
      j({
        en: 'This is not a postcard coastline but a lived one: tides, labour, and the return of the sea at mealtime.',
        zh: '这里不是明信片海岸，而是一条被真正生活出来的海岸。',
      }),
      j({ en: 'Fishing communities', zh: '渔村社区' }),
      j({
        en: 'Fishing villages around Zhanjiang are still part of the economic and emotional engine of the region. Labour is distributed across households: some go to sea, some sort, preserve, transport, or sell.',
        zh: '湛江周边的渔村仍然是地区经济与情感结构的一部分。劳动被分散在家庭内部。',
      }),
      j({ en: 'Fishing villages', zh: '渔村' }),
      j({ en: '100+ villages', zh: '100+ 渔村' }),
      j({
        en: 'What appears at dinner tonight was still moving in open water this morning.',
        zh: '今晚餐桌上的海鲜，今晨还在外海活动。',
      }),
      j({ en: 'Volcanic landscape', zh: '火山地貌' }),
      j({
        en: 'The Leizhou Peninsula surprises visitors because its underlying logic is volcanic rather than fluvial. Black basalt, crater lakes, and mineral-rich soils produce a landscape that feels tougher and more elemental.',
        zh: '雷州半岛最让初访者意外的一点，是它的底层逻辑更接近火山地貌。黑色玄武岩、玛珥湖和富含矿物的土壤让这里显得更硬朗。',
      }),
      j({ en: 'Volcanic cones', zh: '火山锥' }),
      j({ en: '80+', zh: '80+' }),
      j({
        en: 'Geological time is not buried here; it still surfaces in farms, shorelines, and craft textures.',
        zh: '在这里，地质时间并没有被埋进过去，而仍然持续浮现在农田、海岸和器物纹理中。',
      }),
    ],
  );
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Chaoshan Kungfu Tea is not a performance but a daily practice. The 21-step brewing ritual is how conversation, hospitality, and time itself are structured in this region.',
        zh: '潮汕功夫茶不是表演而是日常实践。二十一式冲泡仪式是这个地区组织对话、待客和时间本身的方式。',
      }),
      j({ en: 'Tea varieties', zh: '茶品种' }),
      j({ en: '100+ Dancong', zh: '100+ 单丛' }),
      j({
        en: 'A cup of Kungfu Tea is not about the tea alone — it is about the pace of the afternoon.',
        zh: '一杯功夫茶不只关乎茶本身——它关乎整个下午的节奏。',
      }),
      j({ en: 'Ancient city', zh: '古城' }),
      j({
        en: 'The old city of Chaozhou has been continuously inhabited for over 1,600 years. Its streets, temples, and clan halls form a living archive of Teochew culture.',
        zh: '潮州古城已连续有人居住超过1600年。它的街道、庙宇和宗祠构成了潮汕文化的活档案。',
      }),
      j({ en: 'Heritage sites', zh: '文保单位' }),
      j({ en: '700+ sites', zh: '700+ 处' }),
      j({
        en: 'Every lane in the old city holds a story that is still being told.',
        zh: '古城的每一条巷子都有一个仍在被讲述的故事。',
      }),
      j({ en: 'Porcelain and craft', zh: '陶瓷与手工艺' }),
      j({
        en: 'Chaozhou porcelain has been exported along maritime trade routes for centuries. Today, the craft continues in workshops where technique is passed through families.',
        zh: '潮州瓷器沿海上贸易路线出口了数百年。如今，这门手艺在家族传承的作坊中延续。',
      }),
      j({ en: 'Porcelain history', zh: '制瓷史' }),
      j({ en: '1,300+ years', zh: '1300+ 年' }),
      j({
        en: 'The kiln fire has not gone out in Chaozhou for over a millennium.',
        zh: '潮州的窑火一千多年未曾熄灭。',
      }),
    ],
  );
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Begin at Huguangyan, where a calm ring of water sits inside a volcanic crater formed 160,000 years ago.',
        zh: '从湖光岩开始：约16万年前形成的火山口，如今盛着一圈安静的湖水。',
      }),
      j({
        en: "This UNESCO geopark preserves one of China's best-known maar volcano landscapes.",
        zh: '这里是联合国教科文组织地质公园，也是中国最具代表性的玛珥火山地貌之一。',
      }),
      j([
        'UNESCO geopark crater',
        '2.3 km rim trail',
        'Volcanic geology museum',
      ]),
      j({ en: 'Dongfeng Seafood Market', zh: '东风海鲜市场' }),
      j({
        en: 'By late morning the route drops into the working pulse of the coast: foam boxes, wet concrete, shouted prices.',
        zh: '接近中午，路线转入真正运作中的海岸脉搏：泡沫箱、潮湿地面、此起彼伏的叫价声。',
      }),
      j({
        en: "Dongfeng Market is not staged for visitors. Its auction rhythm reveals the everyday system behind Zhanjiang's food culture.",
        zh: '东风海鲜市场并不是为游客设计的舞台。这里的竞价节奏直接揭示了湛江饮食文化背后的日常系统。',
      }),
      j([
        'Wholesale seafood lanes',
        'Morning bidding rhythm',
        'Seasonal catch hierarchy',
      ]),
      j({ en: 'Xiashan French Heritage', zh: '霞山法式遗迹' }),
      j({
        en: 'In the afternoon, the route slows down in Xiashan, where older streets hold the memory of the former French leasehold.',
        zh: '到了下午，路线在霞山慢下来。老街仍保存着法租时期留下的痕迹。',
      }),
      j({
        en: 'Colonial architecture has been folded into schools, shops, and daily routines here.',
        zh: '这里的殖民建筑已被折进学校、店铺和日常步行路径之中。',
      }),
      j([
        'Former customs routes',
        'Catholic church quarter',
        'Old villa streetscape',
      ]),
      j({ en: 'Jinsha Bay and Seafood Dinner', zh: '金沙湾与海鲜晚餐' }),
      j({
        en: 'The route closes at Jinsha Bay, where the day resolves at the table.',
        zh: '路线最后在金沙湾收束，这一天最终回到餐桌上。',
      }),
      j({
        en: 'In Zhanjiang, seafood is the edible end point of an entire coastal system.',
        zh: '在湛江，海鲜是整套海岸系统最终可以被吃进身体里的结果。',
      }),
      j([
        'Bayfront promenade',
        'Multi-course seafood table',
        'Sunset tide line',
      ]),
  ...
  const route2Res = await dataSource.query(
    ...
    [
      ...
      j({
        en: 'A two-day immersion into Chaoshan Kungfu Tea — from mountain tea gardens to the 21-step brewing ritual.',
        zh: '两天沉浸式体验潮汕功夫茶——从凤凰山茶园到二十一式冲泡仪式。',
      }),
      j({
        en: 'Tea in Chaoshan is not a beverage but a social grammar — the way time, hospitality, and conversation are structured.',
        zh: '在潮汕，茶不是饮品而是社交语法——时间、待客和对话的组织方式。',
      }),
    ],
  );
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Begin on Paifang Street, where century-old tea shops line the ancient thoroughfare beneath ornate memorial arches.',
        zh: '从牌坊街开始，百年茶铺在牌坊下一字排开。',
      }),
      j({
        en: 'These tea houses are not museums — they are daily gathering points where the 21-step Kungfu Tea ritual is practiced as naturally as breathing.',
        zh: '这些茶铺不是博物馆——它们是日常聚集点，二十一式功夫茶仪式在这里如呼吸般自然。',
      }),
      j([
        'Century-old tea shops',
        'Live brewing demonstrations',
        'Dancong tasting',
      ]),
      j({ en: 'Kaiyuan Temple & Old City', zh: '开元寺与古城' }),
      j({
        en: 'After tea, walk through the old city to Kaiyuan Temple, where 1,300 years of Buddhist history meets Teochew architectural craft.',
        zh: '品茶之后，穿过古城走到开元寺，1300年佛教历史与潮汕建筑工艺在此相遇。',
      }),
      j({
        en: 'The temple complex shows how Chaozhou absorbed outside influences while maintaining its own aesthetic language.',
        zh: '寺庙群展示了潮州如何在吸收外来影响的同时保持自己的美学语言。',
      }),
      ...
      j({
        en: 'Day two begins with a drive up Phoenix Mountain, where Dancong tea trees grow at 600-1200m elevation in volcanic soil.',
        zh: '第二天从凤凰山开始，单丛茶树在600-1200米海拔的火山土壤中生长。',
      }),
      j({
        en: "Each ancient tea tree produces a unique flavour profile. The mountain's microclimate creates the conditions for over 100 named varieties.",
        zh: '每棵古茶树都有独特的风味。山上的微气候创造了100多个命名品种的条件。',
      }),
      j([
        'Ancient tea trees (400+ years)',
        'Altitude tasting comparison',
        'Tea picking experience',
      ]),
      j({ en: 'Afternoon Tea Ceremony', zh: '下午茶道体验' }),
      j({
        en: 'Return to the old city for a formal tea ceremony with a master brewer, learning the complete 21-step Kungfu Tea ritual.',
        zh: '回到古城，跟随茶艺师体验完整的二十一式功夫茶仪式。',
      }),
      j({
        en: 'The ceremony is not about perfection but about presence — each step teaches you to slow down and pay attention.',
        zh: '茶道不是关于完美而是关于在场——每一步都教你慢下来、注意当下。',
      }),
      j([
        'Full 21-step ceremony',
        'Master brewer guidance',
        'Tea ware appreciation',
      ]),
  ...
  const coll2Res = await dataSource.query(
    ...
    [
      ...
      j({ en: 'Chaoshan Tea Culture Route', zh: '潮汕功夫茶文化路线' }),
      j({
        en: 'Handcrafted tea ware and Dancong tea from Chaozhou — objects that carry the ritual of Kungfu Tea.',
        zh: '潮州手工茶器与凤凰单丛——承载功夫茶仪式的器物。',
      }),
    ],
  );
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'A bowl fired from Leizhou volcanic clay, carrying the dark mineral tones of the peninsula.',
        zh: '使用雷州火山陶土烧制，带着半岛深色矿物质调。',
      }),
      j({
      ...
      j([
        '/uploads/seed/volcanic-soil-bowl-1200.jpg',
        '/uploads/seed/pottery-workshop-1200.jpg',
      ]),
      j({ en: 'Chaozhou Zhuni Teapot', zh: '潮州朱泥手拉壶' }),
      coll2Id,
      j({ en: 'Master crafted', zh: '大师手作' }),
      j({
        en: 'A hand-pulled zhuni clay teapot from Chaozhou, designed specifically for Kungfu Tea brewing.',
        zh: '潮州手拉朱泥壶，专为功夫茶冲泡设计。',
      }),
      j({
        en: 'Chaozhou zhuni clay, unglazed interior',
        zh: '潮州朱泥，内壁无釉',
      }),
      j({ en: '120ml capacity, 8cm height', zh: '容量120ml，高8cm' }),
      j({ en: 'Fengxi, Chaozhou', zh: '潮州·枫溪' }),
      j({
        en: 'Season with tea before first use. Never use soap.',
        zh: '首次使用前用茶水养壶。切勿使用洗涤剂。',
      }),
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Born in Chaozhou, specializing in food culture and tea ceremony interpretation.',
        zh: '潮州人，专注饮食文化和茶道口译。',
      }),
      ...
      j({
        en: 'Former university lecturer, now coordinating academic and corporate study visits.',
        zh: '前大学讲师，现协调学术和企业学访。',
      }),
    ],
  );
  ...
  await dataSource.query(
    ...
    [
      j({
        en: 'Is this guide service or interpreting?',
        zh: '这是导游还是口译服务？',
      }),
      j({
      ...
      j({
        en: 'Can I book only restaurant or transport help?',
        zh: '可以只预约餐厅或交通支持吗？',
      }),
      j({
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Community event with route narrators and local interpreters sharing coastal stories over seafood.',
        zh: '由路线讲述者与本地口译员共同参与的社区活动，在海鲜餐桌上分享海岸故事。',
      }),
      j(['community', 'story', 'food']),
      j(['southern-sea-table']),
      j({ en: 'Chaoshan Kungfu Tea Festival', zh: '潮汕功夫茶文化节' }),
      j({
        en: 'Four days of immersive Kungfu Tea culture — from mountain gardens to master ceremonies.',
        zh: '四天沉浸式功夫茶文化体验——从山间茶园到大师茶道。',
      }),
      j({
        en: 'The annual tea festival brings together tea masters, ceramic artists, and cultural interpreters for workshops, tastings, and ceremonies.',
        zh: '年度茶文化节汇聚茶艺大师、陶瓷艺术家和文化口译员，举办工作坊、品鉴会和茶道仪式。',
      }),
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: 'Found a four-generation tea shop at the corner of Paifang Street — their Dancong is all from their own garden.',
        zh: '在牌坊街拐角处发现一家传承四代的老茶铺，凤凰单丛都是自家茶园采摘的。',
      }),
  ...
  await dataSource.query(
    ...
    [
      ...
      j({
        en: "Describe what you saw, heard, and smelled during a morning at Zhanjiang's coast. Focus on the working rhythm rather than scenery.",
        zh: '描述你在湛江海岸的一个清晨所见、所闻、所嗅。关注劳动节奏而非风景。',
      }),
      j({ en: 'The tea ritual', zh: '茶的仪式' }),
      j({
        en: 'Write about a moment during Kungfu Tea that changed how you think about time or attention.',
        zh: '写一个功夫茶过程中改变你对时间或注意力看法的瞬间。',
      }),
    ],
  );
    ...
    [
      j({
        ...
        stats: [
          {
            title: { en: '2', zh: '2' },
            description: { en: 'Cities Explored', zh: '深度探索城市' },
          },
          {
            title: { en: '2', zh: '2' },
            description: { en: 'Curated Routes', zh: '精选路线' },
          },
          {
            title: { en: '2', zh: '2' },
            description: { en: 'Cultural Products', zh: '文创商品' },
          },
          {
            title: { en: '2', zh: '2' },
            description: { en: 'Local Interpreters', zh: '本地口译员' },
          },
        ],
      }),
      j([
      ...
      j([
        {
          id: '01',
          title: { en: 'Culture', zh: '文化' },
          body: {
            en: 'Read city stories behind each destination.',
            zh: '阅读每个目的地背后的城市故事。',
          },
          href: '/culture',
        },
        {
          id: '02',
          title: { en: 'Story Routes', zh: '故事路线' },
          body: {
            en: 'Follow one cultural thread through a city.',
            zh: '沿着一条文化线索探索一座城市。',
          },
          href: '/routes',
        },
        {
          id: '03',
          title: { en: 'Interpreter Service', zh: '口译服务' },
          body: {
            en: 'Book local bilingual support.',
            zh: '预约本地双语支持。',
          },
          href: '/interpreting',
        },
        {
          id: '04',
          title: { en: 'Lingnan Store', zh: '文创商城' },
          body: {
            en: 'Take home objects tied to stories.',
            zh: '带走与故事相关联的器物。',
          },
          href: '/shop',
        },
      ...
      j([
        {
          slug: 'zhanjiang',
          title: { en: 'Southern Coast', zh: '南方海岸' },
          body: {
            en: 'Volcanic shoreline and maritime life.',
            zh: '火山海岸与海洋生活。',
          },
        },
        {
          slug: 'chaozhou',
          title: { en: 'Kungfu Tea', zh: '功夫茶' },
          body: {
            en: 'A thousand years of mastery in one cup.',
            zh: '一杯茶里的千年功夫。',
          },
        },
      ]),
      j([
        {
          quote: {
            en: 'I left understanding why every dish mattered.',
            zh: '我终于明白每一道菜为何重要。',
          },
          name: { en: 'Lina, Singapore', zh: 'Lina，新加坡' },
        },
        {
          quote: {
            en: 'The tea ceremony changed how I think about time.',
            zh: '茶道改变了我对时间的理解。',
          },
          name: { en: 'James K., Australia', zh: 'James K.，澳大利亚' },
        },
      ]),
