...
内容、预约、支付与运营接口：城市文化、路线、传译、店铺与 PayPal 支付、社区、账户与后台管理。

- 技术栈：NestJS 11 · TypeORM · PostgreSQL 16 · JWT · PayPal
...
- 环境变量：`DB_*`、`JWT_SECRET`、PayPal 与媒体存储等；完整清单见 `.env.production.example`（值不入库、不入文档）
