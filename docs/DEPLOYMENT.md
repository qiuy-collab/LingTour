...
### 2.3 Admin 后台 (`projects/proj-1778970788262-5mcldi/admin-frontend/.env`)
...
```bash
cd projects/proj-1778970788262-5mcldi/admin-frontend
...
# 生产构建
npm run build
# 输出: projects/proj-1778970788262-5mcldi/admin-frontend/dist/
...
server {
    ...
    # Admin 静态文件
    root /var/www/lingtour/projects/proj-1778970788262-5mcldi/admin-frontend/dist;
    index index.html;
...
cd projects/proj-1778970788262-5mcldi/admin-frontend && npm run build  # 构建 Admin
